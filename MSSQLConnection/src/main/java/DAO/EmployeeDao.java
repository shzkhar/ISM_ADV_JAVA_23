...
public class EmployeeDao {
	...
	{
		String insertquery = "insert into employee(id,name,sal,desg,orgname) values('"+e.getId()+"','"+e.getName()+"','"+e.getSal()+"','"+e.getDesg()+"','"+e.getOrgname()+"')";
	...
	public static int update(EmployeeBean e)
	{
		...
		String insertquery = "update Employee set name = 'Yogendra' where id = 1";
		Connection c = JDBCDemo.getConnection();
	...
	{
        String insertquery = "delete from Employee where id = 1";
	...
	public static void main(String[] args) {
		EmployeeBean e1 = new EmployeeBean(2,"Saurav",25000,"Python","OmniMd");
